...
the development lifecycle \cite{habib2022sca}. Tools such as CodeQL, Semgrep,
and SonarQube have become first-class citizens in DevSecOps workflows, integrated
directly into CI/CD pipelines to catch vulnerabilities before deployment \cite{githubseclab2023codeql}.
...
30--60\% \cite{habib2022sca}. This high false-alarm rate has serious
...
\begin{enumerate}
  \item \textbf{Detection layer}: CodeQL SAST analysis on OWASP Benchmark Java
        test cases \cite{owasp2023benchmark}, producing SARIF-format results.
